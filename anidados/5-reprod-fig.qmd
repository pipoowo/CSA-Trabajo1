...
Dentro de las principales dificultades que se encontraron para el proceso de reproducción fue la falta de los códigos relacionados a la limpieza de la base de datos. Esto generó que se realizaran diversos intentos para alcanzar la muestra final de 25.286 casos declarada por los autores.
...
Otra dificultad fue que el libro de códigos estaba erróneo en la encuesta del año AGREGAR, ya que los casos perdidos fueron identificados como 97,98 y 99 pero correspondían a los valores -1 y -2.
