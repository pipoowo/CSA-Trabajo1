...
La elección de este artículo se fundamenta por tres motivos principales: su relevancia regional, su aporte teórico e interdisciplinario, y su transparencia metodológica. En relación a su relevancia regional, este artículo aborda una temática clave para comprender la cohesión social y las dinámicas de la política laboral en América Latina, ya que al analizar cómo los diferentes modelos económicos impactan en la sociedad, permite enriquecer el debate y generar evidencia sobre la percepción que se tiene de las organizaciones de los trabajadores en la región. En segundo lugar, el texto propone una articulación análitica entre las clases sociales, los tipos de capitalismo y la legitimidad social de los sindicatos. Por último, este artículo es un estudio cuantitativo con un alto rigor analítico y que destaca por su adhesión a las prácticas de Ciencia Abierta, ya que al liberar su base de datos y códigos de programación en un repositorio público, posibilita y facilita realizar el ejercicio de reproducibilidad.
