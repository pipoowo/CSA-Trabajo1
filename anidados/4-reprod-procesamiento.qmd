...
En primer lugar, se cargan las librerías necesarias con _pacman_. Luego, se desactiva la notación científica para facilitar la lectura de los datos. Por último, se limpia el entorno de trabajo, borrando cualquier objeto o dato que estuviera previamente cargado.
...
Se importan las dos bases de datos a utilizar. La función _readRDS_ carga los datos del año 2018 y los asigna al objeto "lb_2018", y _load_ carga los datos del año 2020 que están en formato .rdata y lo denomina "lb_2020".
