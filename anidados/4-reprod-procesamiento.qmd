...
Por último, la sexta categoría corresponde a autoempleados informales compuesta por trabajadores independientes en ocupaciones de autoempleo que poseen niveles educativos bajos o medios (valores 1 y 2). Cualquier combinación de datos que no coincida con estos criterios se clasifica como NA.
...
En este paso final, el objetivo es asignar etiquetas descriptivas a los valores numéricos de las variables categóricas y dicotómicas. 

En conf_sindicato_dic, el valor 1 se etiqueta como "mucha o algo de confianza" y el valor 0 como "poca o nada de confianza"
```{r}
#| echo: true
#| eval: false
...
En la variable clase_social los números del 1 al 6 se asocian a las categorías "grandes empleadores", "pequeños empleadores", "pequeña burguesía", "clase media", "clase trabajadores" y "autoempleados informales" respectivamente.
```{r}
#| echo: true
#| eval: false
...
Para la variable posicion_pol_ord el valor 1 corresponde a "izquierda", el valor 2 a "centro", el valor 3 a "derecha", y el valor 4 a "sin identificación".
```{r}
#| echo: true
#| eval: false
...
La variable sexo tiene el valor 0 identificado como "hombre" y el valor 1 como "mujer"
```{r}
#| echo: true
#| eval: false
...
Por último, se asignan los valores numéricos a siglas de cada país en un formato de tres letras, y se transforman los códigos a texto.
```{r}
#| echo: true
#| eval: false
