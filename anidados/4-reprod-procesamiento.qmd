...
**PASO 6:**
Se etiquetan las variables para que sean categóricas. Para la variable confianza en sindicatos, se asignan las etiquetas "Mucha o algo de confianza" al valor 1 y "Poca o nada de confianza" al valor 0. Para la variable clase social, se asignan etiquetas descriptivas a cada una de las seis categorías. Para la variable posición política, se asignan etiquetas a cada una de las cuatro categorías. Para la variable sexo, se asignan las etiquetas "Hombre" y "Mujer" a los valores 0 y 1 respectivamente. Por último, para la variable país, se asignan códigos de texto de tres letras a cada uno de los códigos numéricos originales. Se realizó este paso al final para no tener problemas cuando se unieron ambas bases de datos en el paso 5.
```{r}
#| echo: true
#| eval: false
